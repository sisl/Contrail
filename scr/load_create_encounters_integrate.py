...
#                         zoom=10, center=(40.63993, -73.77869), 
    ...
    html.Div([
        dash_table.DataTable(
            ...
            editable = True,
            row_deletable = True,
            style_table={'width': '1500px', 'height': '750px', 'display': "block"}),
...
@app.callback([Output('encounter-ids', 'value'),
              ...
              Input('create-mode', 'n_clicks'),
               ...
               [State('ac-index', 'value'),
               State('ac-ids', 'value')])
def update_dropdowns_value(encounter_id_selected, create_n_clicks, start_new_n_clicks, end_new_n_clicks, ref_data, ac_value, ac_selected): #encounter_value, 
    ctx = dash.callback_context.triggered[0]['prop_id'].split('.')[0]
...
if __name__ == '__main__':
    app.run_server(debug=True, port=8340)